...
.directive("filetree", function($compile, $timeout) {
  return {
    ...
    link : function(scope, element, attrs) {
      $(element).fileTree(scope.$eval(attrs.filetree), function(e) {
        $timeout(function() {
          scope.onPick({
            pick : e
          });
...
.directive("sortui", [ 'apiRoot', function($compile, apiRoot) {
...
.directive("uipage", [ 'apiRoot', function($compile, apiRoot) {
