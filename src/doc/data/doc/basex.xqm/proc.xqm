(:~
 ...
 :)
module namespace proc = "x-http://basex.org/modules/proc";
...
(:~
 ...
 :
 : @error bxerr:BXPRnnnn If the command results in an error, an XQuery error will be raised. Its code will consist of the letters <code>BXPR</code> and four digits with the command’s exit code.
