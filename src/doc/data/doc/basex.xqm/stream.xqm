(:~
 ...
 :)
module namespace stream = "x-http://basex.org/modules/stream";
declare namespace bxerr = "http://basex.org/errors";

(:~
 : Returns a materialized instance of the specified <code>$value</code> :
 ...
 :)
declare function stream:materialize($value as item()*) as item()* external;
